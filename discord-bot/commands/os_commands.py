...
RICHARD_SYSTEM = (
    "You are [Your Name]'s Product OS assistant. Richard is a [Your Role] at [Your Company], "
    "leading CDP implementation. Be concise, direct, and use markdown. "
...
def setup_os_commands(bot: commands.Bot):
    ...
    @bot.tree.command(name="weekly-update", description="Draft weekly update for [Your Manager] (<300 words)")
    async def weekly_update(interaction: discord.Interaction):
        ...
        reply = ask_claude(
            RICHARD_SYSTEM,
            f"Reply in under 600 characters (300 words max). Draft my weekly update for [Your Manager]. "
            f"Scannable bullet points. Include: completed, in progress, blockers needing [Your Manager], decisions needed. "
