...
3. **Categorize tests:**
   ...
   - **Privacy / PII** — sensitive fields masked, excluded from exports
...
**Sign-off Required From:** [relevant team members]
...
- `data-quality-check [source]` — validate data ingestion specifically
