...
**Agent:** Enablement & Change Manager — see `Agents/enablement-manager/enablement-manager.md` for full context.
...
- `adoption-check` — schedule a 4-week post-launch adoption review now, before you forget
